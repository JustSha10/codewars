...
// The returned function should take an array of numbers as its parameter, and return 
// an array of those numbers multiplied by the number that was passed into the first function.
...
function factory(x){
    return (array) => array.map(number => number * x);
}