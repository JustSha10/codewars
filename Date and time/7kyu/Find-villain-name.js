...
function getVillainName(birthday){
    ...
    const month = [
        "Evil", "Vile", "Cruel", "Trashy", "Despicable", 
        "Embarrassing", "Disreputable", "Atrocious", 
        "Twirling","Orange","Terrifying","Awkward"
    ];
    const day = [
    ...
    return month[birthday.getMonth()] + ` ` + day[`${birthday.getDate()}`.split(``).reverse()[0]];
  }
...
// OR
  ...
  function getVillainName1(birthday) {
    return month[birthday.getMonth()] + " " + date[birthday.getDate() % 10];
  }

  console.log(getVillainName1(new Date("April 21")));